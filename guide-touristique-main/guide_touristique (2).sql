...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 21 oct. 2021 à 23:31
...
INSERT INTO `restauration` (`id`, `nom`, `adresse`, `menu`, `tel`, `email`, `page_web`, `type`) VALUES
(1, 'aaa', 'ffff', 'tttttt', 7777777, 'iiiiiiii', 'vvvvvv', 'uuuuuuu'),
(2, 'aaa', 'ffff', 'tttttt', 7777777, 'iiiiiiii', 'vvvvvv', 'uuuuuuu'),
(3, 'aaa', 'ffff', 'tttttt', 7777777, 'iiiiiiii', 'vvvvvv', 'uuuuuuu'),
(4, 'aaa', 'ffff', 'tttttt', 7777777, 'iiiiiiii', 'vvvvvv', 'uuuuuuu');

-- --------------------------------------------------------

--
-- Structure de la table `tourist`
--

CREATE TABLE `tourist` (
  `idtourist` int(11) NOT NULL,
  `nom` int(11) NOT NULL,
  `cin_passport` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
